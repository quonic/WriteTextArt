# Run this in an administrative PowerShell prompt to install the WriteTextArt PowerShell module:
#
# iex (New-Object Net.WebClient).DownloadString("https://github.com/quonic/WriteTextArt/raw/master/Install.ps1")

# Some general variables
$ModuleName = 'WriteTextArt'
$DownloadURL = 'https://github.com/quonic/WriteTextArt/raw/master/release/WriteTextArt-current.zip'
